...
import org.cloudsimplus.datacenters.CustomDatacenterSimple;
...
public class CloudSimulation implements Runnable {
        ...
        final List<Host> hostList)
    {
        ...
        // Switching to the Custom Datacenter.
        final var dc = new CustomDatacenterSimple(cloudsimplus, hostList, allocationPolicy);
